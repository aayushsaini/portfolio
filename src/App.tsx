  ...
  return (
    <div className="min-h-screen bg-[#0a0f0d] text-gray-300 font-mono">
      <div className="max-w-4xl mx-auto px-6 py-8">
        <Navigation />
        <header className="mt-[13vh] mb-16">      
          ...
          <div className="flex flex-wrap gap-4">
            <a href="mailto:aayushs99@icloud.com" className="flex items-center gap-2 bg-gray-800/50 hover:bg-green-900 hover:outline-green-600 hover:outline  px-4 py-2 transition-colors">
              <img src="https://img.icons8.com/?size=100&id=X0mEIh0RyDdL&format=png&color=000000" alt="Email Icon" width={18} height={18} />
              Send an email
            </a>
            <a href="https://linkedin.com/in/aayush-saini" className="flex items-center gap-2 bg-gray-800/50 hover:bg-green-900 hover:outline-green-600 hover:outline  px-4 py-2 transition-colors">
              <img src="https://img.icons8.com/?size=100&id=xuvGCOXi8Wyg&format=png&color=000000" alt="LinkedIn Icon" width={18} height={18} />
              /in/aayush-saini
            </a>
            <a href="https://github.com/aayushsaini" className="flex items-center gap-2 bg-gray-800/50 hover:bg-green-900 hover:outline-green-600 hover:outline px-4 py-2 transition-colors">
