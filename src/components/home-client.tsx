...
export function HomeClient({ heroTitle, heroSubtitle, featuredProject }: HomeClientProps) {
    ...
    return (
        <div className="relative w-full">
            ...
            <section className="min-h-screen flex flex-col justify-center pt-20 relative z-10 pointer-events-none">
                <motion.div
                    className={cn(
                        'max-w-7xl mx-auto px-6 w-full relative pointer-events-auto transition-opacity duration-700',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
                        ...
                        >
                            <Link href={`/work/${featuredProject.id}`}>
                                <div className="h-full min-h-[400px] rounded-3xl overflow-hidden relative group cursor-pointer border border-zinc-200 dark:border-white/5 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-sm shadow-2xl">
                                    <Image
                                    ...
                                    <div className="absolute inset-0 bg-zinc-100/40 dark:bg-zinc-900/40 border border-zinc-200 dark:border-white/5 p-8 flex flex-col justify-between hover:bg-zinc-200/60 dark:hover:bg-zinc-800/60 transition-all duration-500 backdrop-blur-sm shadow-xl group-hover:shadow-2xl">
                                        ...
                                        <div className="flex flex-wrap gap-2 relative z-10">
                                            {[
                                                ...
                                                <span
                                                    key={t}
                                                    className="text-xs font-medium text-zinc-700 dark:text-zinc-300 bg-zinc-200/50 dark:bg-white/5 border border-zinc-300 dark:border-white/10 rounded-lg px-3 py-2 group-hover:bg-zinc-300/50 dark:group-hover:bg-white/10 group-hover:border-zinc-400 dark:group-hover:border-white/20 transition-all"
                                                >
                                                    {t}
                                                </span>
                                            ))}
