      ...
      <article className="max-w-3xl mx-auto">
        <header className="mb-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {post.tags.map(tag => (
              <span key={tag} className="px-3 py-1 rounded-full border border-zinc-300 dark:border-white/10 bg-zinc-100 dark:bg-white/5 text-xs text-zinc-600 dark:text-zinc-300">
                {tag}
              </span>
            ))}
          </div>
        ...
        <div className="w-full aspect-video rounded-3xl overflow-hidden mb-12 border border-zinc-200 dark:border-white/5">
